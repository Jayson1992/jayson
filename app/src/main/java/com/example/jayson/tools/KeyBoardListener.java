...
/**
 * 解决webView键盘遮挡问题的类
 * Created by Kearney on 2018/8/18.
 */
...
// this.mhanHandler = handler;
    ...
    private void possiblyResizeChildOfContent() {
        ...
        if (usableHeightNow != usableHeightPrevious) {
            ...
            if (NavigationStatusBarUtils.checkDeviceHasNavigationBar(activity)){
                usableHeightSansKeyboard = mChildOfContent.getRootView().getHeight() - NavigationStatusBarUtils.getNavigationBarHeight(activity);
            }else {
